...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func makePipes() {
        ...
        pipe2.position = CGPoint(x: self.frame.midX + self.frame.width, y: self.frame.midY - pipeTexture2.size().height / 2 - gapHeight + pipeOffset)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if gameOver == false {
            ...
            if contact.bodyA.categoryBitMask == ColliderType.Gap.rawValue || contact.bodyB.categoryBitMask == ColliderType.Gap.rawValue {
                ...
                gameOverLabel.text = "Game Over! Tape to play again."
    ...
    func setupGame() {
        ...
        ground.physicsBody = SKPhysicsBody(rectangleOf: CGSize(width: self.frame.width, height: 0.1))
